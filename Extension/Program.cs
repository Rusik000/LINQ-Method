...
namespace Extension
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            new Debtor("Martin S. Malinowski", DateTime.Parse("January 17, 1992"), "767-599-3523", "MartinSMalinowski@dayrep.com", "3749 Capitol Avenue New Castle, IN 47362", 1816),
            ...
            new Debtor("Lionel A. Cook", DateTime.Parse("April 16, 1972"), "201-727-5962", "LionelACook@jourrapide.com", "29 Goldleaf Lane Red Bank, NJ 07701", 2712),
            ...
            //debtorsByDomains.ForEach(d => Console.WriteLine($"{d.FullName}'s is email {d.Email}"));
            ...
            //debtorsByAge.ForEach(d => Console.WriteLine($"{d.FullName} was born  in  {d.BirthDay.Year}"));
            ...
            //debtorsByDebt.ForEach(d => Console.WriteLine($"{d.FullName} has  {d.Debt}$ debt"));
            ...
            //debtorsByNameLength.ForEach(d => Console.WriteLine($"{d.FullName}'s number is  {d.Phone}"));
            ...
            //onlyWinterDebtors.ForEach(d => Console.WriteLine($"{d.FullName} was born  on  {d.BirthDay.Month} Month"));


            //6) Borcu, umumi borclarin orta borcunnan cox olan borclulari cixarmaq ve 
            //evvel familyaya gore sonra ise meblegin azalmagina gore sortirovka etmek
            ...
            //debtorsSortedBySurname.ForEach(d => Console.WriteLine($"{d.FullName}"));

            var descDebtorsSortedByDebt = debtorsHigherThanAvg
                .OrderByDescending(d => d.Debt)
                .ToList();

            //descDebtorsSortedByDebt.ForEach(d => Console.WriteLine($"{d.Debt}"));


            //7) Telefon nomresinde 8 olmayan borclularin yalniz familyasin, 
            //yashin ve umumi borcun meblegin cixarmaq
            ...
            debtors3.ForEach(d =>
            {
                ...
                //Console.WriteLine($"{nameComponents[nameComponents.Length - 1]} {DateTime.Now.Year - d.BirthDay.Year} Years {d.Debt} Debt");
            });


            //8)Adinda ve familyasinda hec olmasa 3 eyni herf olan borclularin 
            //siyahisin cixarmaq ve onlari elifba sirasina gore sortirovka elemek
            ...
            //debtors4.ForEach(d=>Console.WriteLine($"{d.FullName}"));
            ...
            //13)Nomresinde tekrar reqemler olmayan borclularin 
            //ve onlarin borcunun meblegin cixartmaq
            ...
            debtors5.ForEach(d =>
            {
                Console.WriteLine($"{d.FullName} {d.Phone}");
            });
            ...
            //14)Tesevvur edek ki,butun borclari olanlar bugunden etibaren her ay 
            //500 azn pul odeyecekler.Oz ad gunune kimi borcun oduyub qurtara bilenlerin siyahisin cixartmaq
